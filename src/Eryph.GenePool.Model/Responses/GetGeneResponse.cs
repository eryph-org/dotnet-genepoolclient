...
{
    [JsonConstructor]
    public GetGeneResponse(GenesetRefResponse Geneset, string Gene, GeneManifestData Manifest, bool Available, GenePartDownloadUri[]? DownloadUris, GeneUploadStatusResponse? UploadStatus)
    {
    ...
    public void Deconstruct(out GenesetRefResponse geneset, out string gene, out GeneManifestData manifest, out bool available, out GenePartDownloadUri[]? downloadUris, out GeneUploadStatusResponse? uploadStatus)
    {
        geneset = Geneset;
        gene = Gene;
        manifest = Manifest;
