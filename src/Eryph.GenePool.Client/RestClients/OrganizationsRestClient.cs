...
internal class OrganizationsRestClient
{
    ...
    internal HttpMessage CreateListGenesetsRequest(OrganizationName organization,
        ContinuingRequestOptions<ListGenesetsRequestOptions> options)
    {
        var message = _pipeline.CreateMessage();
        var request = message.Request;
        ...
        uri.AddExpandOptions(options.RequestOptions.Expand);
        request.Uri = uri;
    ...
    public async Task<Response<PagedResultResponse<GenesetResponse>>> ListGenesetsAsync(OrganizationName orgName,
        ContinuingRequestOptions<ListGenesetsRequestOptions> options,
        CancellationToken cancellationToken = default)
    {

        return await _pipeline.SendRequestAsync<PagedResultResponse<GenesetResponse>>(
            CreateListGenesetsRequest(orgName, options), options.RequestOptions, cancellationToken).ConfigureAwait(false);

    }

    public Response<PagedResultResponse<GenesetResponse>> ListGenesets(OrganizationName orgName,
        ContinuingRequestOptions<ListGenesetsRequestOptions> options,
        CancellationToken cancellationToken = default)
    {
        return _pipeline.SendRequest<PagedResultResponse<GenesetResponse>>(
            CreateListGenesetsRequest(orgName, options), options.RequestOptions, cancellationToken);
